 ...
 * Class ImportCommand
 *
 * @package SalesIgniter\Common\Console\Command
 */
class ImportCommand extends Command
{
    ...
    {
        $this->setName('salesigniter:import')
    ...
    /**
     * @return \SalesIgniter\Common\Model\Import
     */
    protected function getImportModel()
    {
        return $this->objectManager->create('SalesIgniter\Common\Model\Import');
    }
}
